...
import jsc.exam.com.guidance.adapter.BaseRecyclerViewAdapter;
import jsc.exam.com.guidance.adapter.BlankSpaceItemDecoration;
import jsc.exam.com.guidance.adapter.ClassItemAdapter;
import jsc.exam.com.guidance.bean.ClassItem;
import jsc.exam.com.guidance.fragments.AboutFragment;
import jsc.exam.com.guidance.fragments.GuidanceDialogFragment;
import jsc.exam.com.guidance.fragments.GuidanceLayoutFragment;
import jsc.exam.com.guidance.fragments.GuidancePopupWindowFragment;
import jsc.exam.com.guidance.fragments.GuidanceRippleViewFragment;
import jsc.exam.com.guidance.retrofit.ApiService;
import jsc.exam.com.guidance.retrofit.CustomHttpClient;
import jsc.exam.com.guidance.retrofit.CustomRetrofit;
import jsc.exam.com.guidance.utils.CompatResourceUtils;
...
public class MainActivity extends BaseActivity {
    ...
    private List<ClassItem> getClassItems() {
        ...
        classItems.add(new ClassItem(ClassItem.TYPE_FRAGMENT, "GuidanceRippleView", GuidanceRippleViewFragment.class, true));
        classItems.add(new ClassItem(ClassItem.TYPE_FRAGMENT, "GuidanceLayout", GuidanceLayoutFragment.class, true));
        classItems.add(new ClassItem(ClassItem.TYPE_FRAGMENT, "GuidanceDialog", GuidanceDialogFragment.class, true));
        classItems.add(new ClassItem(ClassItem.TYPE_FRAGMENT, "GuidancePopupWindow", GuidancePopupWindowFragment.class, true));
